      ...
      body: Stack(
        ...
        children: [Column(
          ...
          children: [
            ...
            Center(
              child: Text("Select your interest", style: TextStyle(fontFamily: "Rethink Sans", fontSize: 36, fontVariations: [
            ...
            Center(
              child: Text("Pick up to 3 things you love most", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Rethink Sans", fontSize: 16,fontWeight: FontWeight.w600, // Set weight to 1000 if supported
                  color: Color(0xFF8793A1) )
              ),
            ),
            Padding(padding: EdgeInsets.symmetric(vertical: 25)),

            ...rows.map((rowIndexes) => Padding(
              ...
              child: Row(
                ...
                children: [
                  ...rowIndexes.map((i) {
                    ...
                    final bgColor = isSelected ? tile.selectedBg : unselectedBg;
                    final borderColor = isSelected ? tile.selectedBorder : unselectedBorder;
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        ref.read(myInterestsProvider.notifier).state = current;
                      },
