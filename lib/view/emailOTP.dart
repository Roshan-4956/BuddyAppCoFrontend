    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Center(
            child: Text("An OTP has been sent to your email\naddress. Please enter it below.", textAlign: TextAlign.center, style: TextStyle(fontFamily: "Rethink Sans", fontSize: 16,fontWeight: FontWeight.w600, // Set weight to 1000 if supported
