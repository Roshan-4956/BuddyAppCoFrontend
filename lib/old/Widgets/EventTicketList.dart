...
class TicketCard extends StatelessWidget {
  ...
  const TicketCard({super.key, required this.ticket, this.isExpired = false});
    ...
    return Opacity(
      ...
      child: Stack(
        ...
        children: [
          ...
          isExpired
              ? Image.asset("assets/events/greyTicket.png", fit: BoxFit.fill)
              : Image.asset(ticket.type.ticketAsset, fit: BoxFit.fill),
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isExpired ? Color(0x991E1E1E) : Color(0xFF1E1E1E),
                  ),
                ),
...
class TicketsList extends StatelessWidget {
  ...
  const TicketsList({super.key, required this.ongoing, required this.expired});
